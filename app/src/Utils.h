...
// date", deliberately not the folder's own creation time (that's the ingestion date). Prefers the
...
[[nodiscard]] QDateTime getSourceVideoDate(const QString& sourceVideoPath, const QString& folderPath);
